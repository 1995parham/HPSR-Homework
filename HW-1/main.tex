...
\begin{align}
\begin{split}
    E[x] = \sum_{n = 0}^{10^4}n\frac{\binom{10^4}{n} * (10^4-n)^{5000}}{10^{4^{5000}}}
\end{split}
\end{align}
...
\begin{align}
\begin{split}
    \frac{\binom{10^4}{1} * \binom{5000}{2} * (10^4-1)^{5000-2}}{10^{4^{5000}}}
\end{split}
\end{align}
...
\begin{align}
\begin{split}
    E[x] = \sum_{n = 0}^{2500}n\frac{\binom{10^4}{n} * \prod_{i=0}^{n-1}\binom{5000 - 2i}{2} * (10^4-n)^{5000 - 2n}}{10^{4^{5000}}}
\end{split}
\end{align}
